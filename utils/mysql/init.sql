...
CREATE TABLE IF NOT EXISTS Projects (
    ...
    ProjectAddress VARCHAR(255) NOT NULL COMMENT '项目地址',
    StartDate TIMESTAMP NULL DEFAULT NULL COMMENT '开工日期',
    EndDate TIMESTAMP NULL DEFAULT NULL COMMENT '竣工日期',
...
CREATE TABLE IF NOT EXISTS Labor (
    ...
    WorkDate TIMESTAMP NULL DEFAULT NULL COMMENT '工作日期',
