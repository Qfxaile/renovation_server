...
CREATE TABLE IF NOT EXISTS Labor (
    ...
    WorkDescription TEXT COMMENT '施工项目',
    Image VARCHAR(255) DEFAULT NULL COMMENT '图片链接',
...
CREATE TABLE IF NOT EXISTS ProjectSummary (
    ...
    OtherWages DECIMAL(15, 2) DEFAULT 0.00 COMMENT '其他工工资',
    TotalWages DECIMAL(15, 2) DEFAULT 0.00 COMMENT '总工工资',
...
CREATE TABLE IF NOT EXISTS AccountBooks (
    BookID INT AUTO_INCREMENT PRIMARY KEY COMMENT '流水账ID',
    UserID INT NOT NULL COMMENT '用户ID',
    Title VARCHAR(255) NOT NULL COMMENT '流水账标题（如：2025年收支记录）',
...
CREATE TABLE IF NOT EXISTS AccountEntries (
    EntryID INT AUTO_INCREMENT PRIMARY KEY COMMENT '流水记录ID',
    BookID INT NOT NULL COMMENT '所属流水账ID',
    UserID INT NOT NULL COMMENT '用户ID',
    Date DATETIME NULL DEFAULT NULL COMMENT '日期',
    Project VARCHAR(255) COMMENT '项目名称',
    Income DECIMAL(15, 2) DEFAULT 0.00 COMMENT '收入',
    Expense DECIMAL(15, 2) DEFAULT 0.00 COMMENT '支出',
    Notes TEXT COMMENT '备注',
    FOREIGN KEY (BookID) REFERENCES AccountBooks (BookID) ON DELETE CASCADE,
    FOREIGN KEY (UserID) REFERENCES Users (UserID) ON DELETE CASCADE
);