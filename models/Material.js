...
const Materials = {
    ...
    create: async (data) => {
        const { ProjectID, UserID, Date, MaterialName, Specification, Unit, Image, Quantity, UnitPrice, TotalAmount, Notes } = data;
        const [result] = await pool.query(
            'INSERT INTO Materials (ProjectID, UserID, Date, MaterialName, Specification, Unit, Image, Quantity, UnitPrice, TotalAmount, Notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
            [ProjectID, UserID, Date, MaterialName, Specification, Unit, Image, Quantity, UnitPrice, TotalAmount, Notes]
        );
