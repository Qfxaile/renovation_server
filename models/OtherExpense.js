...
const OtherExpenses = {
    ...
    create: async (data) => {
        const { ProjectID, UserID, Date, ExpenseType, ExpenseDescription, Amount, Image, Notes } = data;
        const [result] = await pool.query(
            'INSERT INTO OtherExpenses (ProjectID, UserID, Date, ExpenseType, ExpenseDescription, Amount, Image, Notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
            [ProjectID, UserID, Date, ExpenseType, ExpenseDescription, Amount, Image, Notes]
        );
